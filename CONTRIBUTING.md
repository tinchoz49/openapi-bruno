...
Fork the project [on GitHub](https://github.com/tinchoz49/openapi-bruno) and check out your copy locally.

```bash
$ git clone git@github.com:tinchoz49/openapi-bruno.git
$ cd openapi-bruno
$ npm install
$ git remote add upstream git://github.com/tinchoz49/openapi-bruno.git
```
